...
public class TablaTokens extends javax.swing.JFrame {
    ...
    public TablaTokens() {
        ...
        jTableTokens.getTableHeader().setFont(new Font("Arial", Font.BOLD, 16));
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/IconoLista.png"))); // NOI18N
